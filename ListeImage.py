...
class ListeImage(swing.JFrame, swing.Scrollable):
		...
		def run(self):
			...
			#self.__dispImage = swing.JTextField(preferredSize=(100, 50), horizontalAlignment=swing.SwingConstants.LEFT)
			#self.__dispImage.text = ""
			#Panel2.add(self.__dispImage)

			listimages = swing.JList(["Started ListeImage.py at Wed Mar 27 16:58:30 CET 2013", "Started ListeImage.py at Wed Mar 27 16:59:15 CET 2013", "Started ListeImage.py at Wed Mar 27 17:11:33 CET 2013"])
			Panel2.add(listimages)
